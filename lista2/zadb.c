...
typedef struct Przekaz
{
    ...
    int th_number;
    int th_max;
    int znak; // 4 bitowy znak z klucza
} Przek;
            ...
            for(i2 = 0; i2 <= 255; ++i2)
            {
                ...
                for(i3 = 0; i3 <= 255; ++i3)
                {
                    ...
                    for(i4 = 0; i4 < 16; ++i4)
                    {
                        ...
                        klucz_th[4] = (unsigned char) ((i4 << 4) | s->znak); //przesuwamy o 4 bity w lewo i logiczne lub z wartością 'znak'
                        ...
                        if(ver > 0.8) // teraz testujemy dalej odszyfrowujac reszte
                        {
                            ...
                            if(ver > 0.7)
                            {
                                ...
                                printf("%d %d %d %d %d %d %d %d %d\n", (int)klucz_th[0], (int)klucz_th[1], (int)klucz_th[2], (int)klucz_th[3], (int)klucz_th[4], (int)klucz_th[5],
                                        (int)klucz_th[6], (int)klucz_th[7], (int)klucz_th[8]);
                            }
                        }
                    }
...
int main (int argc, char **argv)
{
   ...
   */
   ...
   for(j = 0; j < thcount; ++j)
   {
       ...
       tabprzek[j].znak = key[9]; // dzieki temu, bedziemy potem ustawiali odpowiednio znane 4 bity klucza
   }
