...
delta = 0.1^5 / 2; epsilon = 0.1^5 / 2; maxit = 40;
g(x) = x^2 - 4;
pg(x) = 2x; #pochodna g(x)
...
a = 0.0; b = 100000.0;
r, v, it, err = mbisekcji(g , a, b, delta, epsilon);
println("brak pierwiastka1: ", r, ", wartosc w x1: ", v, ", liczba iteracji: ", it, "  ", err);

a = -4.0; b = -3.0;
r, v, it, err = mbisekcji(g , a, b, delta, epsilon);
println("brak pierwiastka2: ", r, ", wartosc w x1: ", v, ", liczba iteracji: ", it, "  ", err);
